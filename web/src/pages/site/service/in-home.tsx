    ...
    return <div className="bg-yellow-100">
        <section className="bg-gray-50 py-16 px-8"
            ...
            <div className="text-center">
                ...
                <h1 className="mt-2 text-3xl font-bold text-gray-800">In-Home Euthanasia</h1>
            </div>

            <div className="mt-8 text-center">
                <p className="text-lg text-gray-600 max-w-7xl mx-auto">
                    When the time comes to say goodbye to a beloved pet, we realize that this is a very difficult decision for most people. Whether sudden or something that was inevitable, we try very hard to make it as comfortable as possible. We have a comfort room that has been created with the comfort and peace of you and your pet first and foremost.                    </p>
                <p className="mt-6 text-lg text-gray-600 max-w-7xl mx-auto">
                    In certain cases, it is sometime difficult to transport to the hospital. In these special cases, we are able to organize and accommodate for your needs. We understand how hard the choice to send a pet over the bridge can be. This is a very specialized service and we are happy to be able to offer this to our clients. We offer a cremation service as well as a return of ashes (if desired) from Okanagan Pet Crematorium in Lake Country.
                </p>
            </div>
