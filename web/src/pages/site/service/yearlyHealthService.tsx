...
export const YearlyHealthyService = () => {
    return <div className="bg-yellow-100">
        <section className="bg-gray-50 py-16 px-8"
            ...
            <div className="text-center">
                ...
                <h1 className="mt-2 text-3xl font-bold text-gray-800">Yearly Health Checks and Vaccinations</h1>
            </div>

            <div className="mt-8 text-center">
                <p className="text-lg text-gray-600 max-w-7xl mx-auto">
                    Aberdeen Veterinary Hospital regularly performs Yearly Health Exams and administers vaccinations to a variety of companion animals. Our veterinarians set you and your pet up on a schedule and send out reminders prior to when vaccines are coming due. We do not believe in over-vaccination and follow the three-year plan for most animals. Annual health exams are important in identifying problems before they become complicated.
                </p>
            </div>
