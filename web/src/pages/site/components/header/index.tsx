      ...
      >
        ...
        <div className="flex-none">
          ...
          >
            ...
            <li>
              <CiUser className='User w-[100px]' onClick={() => (document.getElementById('my_modal_2') as any)?.showModal()} />
              <dialog className="M02 modal flex justify-center bg-none" id="my_modal_2" >
                <div className="M03 modal-box max-w-3xl">
                  <div className="M04 flex h-[580px]">
