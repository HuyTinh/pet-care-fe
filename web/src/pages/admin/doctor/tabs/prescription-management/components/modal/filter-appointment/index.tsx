...
export const FilterAppointmentModal = memo(({
  ...
  const onSubmit = (data: any) => {
    ...
    (document.getElementById("filter_appointment_modal") as any).close(); // Đóng modal sau khi apply
    reset();
  };

  return (
    <dialog id="filter_appointment_modal" className="modal backdrop:!hidden">
      <div className="modal-box w-full max-w-2xl border-2 border-black">
        <div className="text-center text-3xl">Filter Appointment</div>
