...
const Prescription = () => {
    return (
        <dialog id="appointment_prescription_modal" className="modal backdrop:!hidden">
            <div className="modal-box w-full max-w-4xl border-2 border-black">
                ...
                <div className="mt-5 pl-10">
                    <div>
                        <span className="text-lg font-bold text-[#0099CF]">Customer: </span>
                    ...
                    <div className="mt-3">
                        <span className="text-lg font-bold text-[#0099CF]">Pet: </span>
