...
import { useGetAppointmentQuery, useGetPrescriptionByIdQuery } from '@/pharmacist/pharmacist.service';
                    ...
                    <View className=' mt-16'>
                        ...
                        <ScrollView>
                            ...
                            <View className=' p-5 pb-64 '>
                                {!isFetching && ((data as any)?.data as Prescription[]).map((prescription) => (
                                    <Card className='bg-[#E7E7E8] mb-5' onPress={handlePresentModalPress}>
                                        <Card.Content>
                                            <Text className='font-bold text-lg text-[#0D74B1]'>#PC{prescription.id}</Text>
                                            <Text className='text-[#0D74B1] text-base font-medium'>Họ và tên: <Text className='!text-black'>{prescription.customer.last_name} {prescription.customer.first_name}</Text></Text>
                                            <Text className='text-[#0D74B1] text-base font-medium'>Số điện thoại: <Text className='!text-black'>{prescription.customer.phone_number}</Text></Text>
                                    ...
                                    <BottomSheetView>
                                        ...
                                        <View className='flex flex-row justify-between px-5 pb-10'>
                                            <View >
                                                ...
                                                }).format((listData as any)?.data.total_price)} VND</Text>
                                            </View>
                                            <View>
